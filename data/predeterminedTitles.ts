...
export const PREDETERMINED_TITLES: Title[] = [
  ...
  },
  {
    ...
    name: 'Random Numbers',
    emoji: '🎲',
    description: 'Generate random numbers 1-100 for dice alternatives, lottery picks, and numerical decisions (100 total options)',
  ...
  },
  {
    ...
    name: 'Truth or Dare',
    emoji: '😈',
    description: 'Personal questions, silly physical dares, and creative performance challenges for party entertainment (60 total options)',
  ...
  },
  {
    ...
    name: 'Team Picker',
    emoji: '⚽',
    description: 'Sports positions, project roles, team assignments, and group leadership positions for organized activities (50 total options)',
    category: TitleCategory.GAMES,
    items: teamItems,
    isCustom: false,
    isPredetermined: true,
  ...
  },
  {
    ...
    name: 'Book Genres',
    emoji: '📚',
    description: 'Discover your next great read across fiction, non-fiction, and specialized genres (70 total options)',
  ...
  },
  {
    ...
    emoji: '🌍',
    description: 'Dream vacation picker - explore destinations around the world (80 total options)',
    category: TitleCategory.ENTERTAINMENT,
    items: travelItems,
    isCustom: false,
    isPredetermined: true,
  ...
  },
  {
    ...
    emoji: '💡',
    description: 'Writing and art inspiration to spark your creative imagination (75 total options)',
  ...
  },
  {
    ...
    emoji: '🧘',
    description: 'Meditation, breathing, and relaxation techniques for inner peace (60 total options)',
    category: TitleCategory.FAMILY,
  ...
  },
  {
    ...
    name: 'Party Games',
    emoji: '🎪',
    description: 'Group entertainment ideas for gatherings, parties, and social events (70 total options)',
    category: TitleCategory.GAMES,
  ...
  },
  {
    ...
    emoji: '🔬',
    description: 'Educational activities and experiments for learning and discovery (65 total options)',
    category: TitleCategory.EDUCATION,
    items: scienceItems,
    isCustom: false,
    isPredetermined: true,
  ...
  },
  {
    ...
    name: 'Garden Tasks',
    emoji: '🌱',
    description: 'Outdoor and plant care activities for green thumbs and nature lovers (55 total options)',
    category: TitleCategory.FAMILY,
    items: gardenItems,
    isCustom: false,
    isPredetermined: true,
  ...
  },
  {
    ...
    emoji: '🎯',
    description: 'Health, career, relationships, and lifestyle goals for personal growth and self-improvement (65 total options)',
    category: TitleCategory.EDUCATION,
    items: goalItems,
    isCustom: false,
    isPredetermined: true,
  ...
  },
  {
    ...
    name: 'Art Techniques',
    emoji: '🎨',
    description: 'Beginner to advanced drawing, painting, and mixed media techniques for artistic skill development (60 total options)',
    category: TitleCategory.EDUCATION,
  ...
  },
  {
    ...
    name: 'Movie Night',
    emoji: '🎬',
    description: 'Popular movies across genres for your next film viewing experience (75 total options)',
    category: TitleCategory.ENTERTAINMENT,
  ...
  },
  {
    ...
    name: 'Music Genres',
    emoji: '🎵',
    description: 'Musical styles for discovery - explore sounds from around the world (70 total options)',
    category: TitleCategory.ENTERTAINMENT,
  ...
  },
  {
    ...
    emoji: '🏢',
    description: 'Office-appropriate activities for 5, 15, and 30-minute work breaks (55 total options)',
  ...
  },
  {
    ...
    name: 'Study Topics',
    emoji: '🎓',
    description: 'Core academic subjects, foreign languages, and professional skills for student learning and exam prep (80 total options)',
    category: TitleCategory.EDUCATION,
  ...
  },
  {
    ...
    emoji: '🏡',
    description: 'Household task distribution for kitchen, bathroom, living, and outdoor areas (65 total options)',
    category: TitleCategory.FAMILY,
    items: choreItems,
    isCustom: false,
    isPredetermined: true,
  ...
  // DECISIONS Category - Fill the empty category (5 new wheels)
  {
    ...
    emoji: '🤔',
    description: 'Get clear Yes or No answers for any decision you\'re facing (60 total options)',
  ...
  },
  {
    ...
    name: 'Life Choices',
    emoji: '🎭',
    description: 'Major life decisions and directions for personal growth (70 total options)',
    category: TitleCategory.DECISIONS,
  ...
  },
  {
    ...
    emoji: '🌅',
    description: 'Daily activity and mood-based decisions for any time of day (65 total options)',
    category: TitleCategory.DECISIONS,
  ...
  },
  {
    ...
    emoji: '💰',
    description: 'Get definitive buy, don\'t buy, or alternative purchase decisions (60 total options)',
    category: TitleCategory.DECISIONS,
  ...
  },
  {
    ...
    name: 'Weekend Plans',
    emoji: '🏖️',
    description: 'Weekend activity and outing decisions for relaxation and fun (70 total options)',
    category: TitleCategory.DECISIONS,
  ...
  // FOOD Category - Expand with more meal options (3 new wheels)
  {
    ...
    name: 'Snack Attack',
    emoji: '🍪',
    description: 'Quick snacks and light bites for any craving or time of day (65 total options)',
    category: TitleCategory.FOOD,
    items: snackItems,
    isCustom: false,
    isPredetermined: true,
  ...
  },
  {
    ...
    name: 'Dinner Ideas',
    emoji: '🍽️',
    description: 'Evening meal suggestions from quick weeknight to special occasion dinners (75 total options)',
    category: TitleCategory.FOOD,
    items: dinnerItems,
    isCustom: false,
    isPredetermined: true,
  ...
  },
  {
    ...
    emoji: '🥞',
    description: 'Morning meal ideas from quick grab-and-go to leisurely weekend brunches (60 total options)',
    category: TitleCategory.FOOD,
  ...
  // NUMBERS Category - Expand with gaming and luck (2 new wheels)
  {
    ...
    name: 'Dice Games',
    emoji: '🎲',
    description: 'Traditional dice combinations and gaming rolls for tabletop fun (55 total options)',
    category: TitleCategory.NUMBERS,
    items: diceGameItems,
    isCustom: false,
    isPredetermined: true,
  ...
  },
  {
    ...
    name: 'Lucky Numbers',
    emoji: '🍀',
    description: 'Personal lucky numbers and special occasion number selections (65 total options)',
    category: TitleCategory.NUMBERS,
  ...
  // WORKPLACE Category - Expand with team activities (2 new wheels)
  {
    ...
    emoji: '🤝',
    description: 'Office bonding and collaboration ideas for stronger workplace relationships (60 total options)',
    category: TitleCategory.WORKPLACE,
  ...
  },
  {
    ...
    emoji: '🎤',
    description: 'Professional conversation starters and check-ins for productive meetings (55 total options)',
    category: TitleCategory.WORKPLACE,
  ...
  // GAMES Category - Add modern gaming option (1 new wheel)
  {
    ...
    emoji: '🎮',
    description: 'Gaming mood picker for choosing what type of video game to play (65 total options)',
    category: TitleCategory.GAMES,
