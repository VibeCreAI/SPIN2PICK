...
export const PREDETERMINED_TITLES: Title[] = [
  ...
  },
  {
    ...
    name: 'Team Picker',
    emoji: '⚽',
    description: 'Assign teams, roles, and positions for sports, projects, and group activities (50 total options)',
    category: TitleCategory.GAMES,
    items: teamItems,
    isCustom: false,
    isPredetermined: true,
  ...
  },
  {
    ...
    emoji: '🎯',
    description: 'Personal development areas to focus your growth and improvement (65 total options)',
    category: TitleCategory.EDUCATION,
    items: goalItems,
    isCustom: false,
    isPredetermined: true,
  ...
  },
  {
    ...
    name: 'Art Techniques',
    emoji: '🎨',
    description: 'Drawing, painting, and creative methods to explore artistic expression (60 total options)',
    category: TitleCategory.EDUCATION,
  ...
  },
  {
    ...
    name: 'Study Topics',
    emoji: '🎓',
    description: 'Subject rotation for students - academic, language, and skill development (80 total options)',
    category: TitleCategory.EDUCATION,
